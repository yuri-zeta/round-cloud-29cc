...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-cloud-29cc)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-cloud-29cc
```

A live public deployment of this template is available at [https://round-cloud-29cc.templates.workers.dev](https://round-cloud-29cc.templates.workers.dev)
